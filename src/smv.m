 function [net,f_measure,g_mean,precision,recall,err] = smv(net, data_train, labels_train, data_test, labels_test)
...
for ell = 1:n_timestamps
  ...
  predictions = classify_ensemble(net.classifiers(1:T), ones(1,T)/T, ...
